...
/**
 * @module API_REST/service/show-databases
 *
 * @requires lodash
 * @requires module:API_REST/args
 * @requires module:API_REST/db
 * @requires module:API_REST/logger
 */
...
const logger = require('app/logger').getLogger('API_REST.service');
