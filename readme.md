...
* Create a remote repository on [Github][github] with the name `api-rest-generator`. It should look after: `https://github.com//api-rest-generator.git`
